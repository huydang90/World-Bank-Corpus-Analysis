---
title: "World Development Report Analysis"
author: "Huy Dang"
output:
  pdf_document:
    toc: yes
...
wb_corpus_files <- readtext(paste0(path_data, "/WDR_Data/*"),
...
# MEASURE READABILITY OF WORLD DEVELOPMENT REPORT CORPUR

```{r}
# Create readability measures for World Development Report Corpus
...
plot(wb_read$Flesch, type = 'l', xaxt = 'n', xlab = "Flesch Reading Ease (FRE) Measure of World Development Reports", ylab = "Flesch Score")
grid()
...
```{r}
plot(wb_read$Flesch.Kincaid, type = 'l', xaxt = 'n', xlab = "Flesch Kincaid Measure of World Development Reports", ylab = "Flesch Kincaid Score")
grid()
axis(1, at = seq_len(nrow(wb_read)), labels = docvars(wb_corpus, 'Year'))
```
...
```{r}
plot(wb_read$FOG, type = 'l', xaxt = 'n', xlab = "Gunning Fog Measure of World Development Reports", ylab = "Gunning Fog Score")
grid()
axis(1, at = seq_len(nrow(wb_read)), labels = docvars(wb_corpus, 'Year'))
